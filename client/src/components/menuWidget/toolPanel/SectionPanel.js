...
const sectionSource = {
  ...
  endDrag(props, monitor) {
    ...
    if (dropResult) {
      ...
      props.structureActions.addSection(section, dropResult.containerId, dropResult.rowId, dropResult.columnId)
  ...
  render(){
    ...
    return (
      <section className="section-panel">
        ...
        {connectDragSource(<button className="btn-toolpanel btn-block btn-info">Drop me somewhere</button>)}
      </section>
    )
