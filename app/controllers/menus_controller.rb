class MenusController < ApplicationController
  ...
  def export
    ...
    pdf = render_to_string pdf: @filename, zoom: 0.97, template: "menus/export.pdf.erb", layout: 'layouts/pdf.html.erb', page_size: @meta['size'], encoding: "UTF-8", javascript_delay: 1000, orientation: @meta['orientation'], lowquality: false, no_pdf_compression: true, margin:  { top:0, bottom: 0, left: 0, right: 0 }
